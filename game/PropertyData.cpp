...
void PropertyData::SaveTheme(wxXmlDocument* xmldoc) const
{
    ...
    if (widgetType == WidgetType::MainWindow)
        ...
        widgetname = "BotNameDisplay";
    else if (widgetType == WidgetType::RegisterDisplay)
        widgetname = "RegisterDisplay";
    else if (widgetType == WidgetType::InstructionDisplay)
        widgetname = "InstructionDisplay";
    else
        widgetname = "ArenaTerminal";
...
{
    if (famstr == "wxFONTFAMILY_DEFAULT")
        return wxFONTFAMILY_DEFAULT;
    else if (famstr == "wxFONTFAMILY_MODERN")
        return wxFONTFAMILY_MODERN;
    else if (famstr == "wxFONTFAMILY_DECORATIVE")
        return wxFONTFAMILY_DECORATIVE;
    else if (famstr == "wxFONTFAMILY_TELETYPE")
        return wxFONTFAMILY_TELETYPE;
    else if (famstr == "wxFONTFAMILY_SCRIPT")
        return wxFONTFAMILY_SCRIPT;
    else if (famstr == "wxFONTFAMILY_ROMAN")
        return wxFONTFAMILY_ROMAN;
    else if (famstr == "wxFONTFAMILY_SWISS")
...
{
    if (stylstr == "wxFONTSTYLE_NORMAL")
        return wxFONTSTYLE_NORMAL;
    else if (stylstr == "wxFONTSTYLE_ITALIC")
        return wxFONTSTYLE_ITALIC;
    else if (stylstr == "wxFONTSTYLE_SLANT")
...
{
    if (wtstr == "wxFONTWEIGHT_NORMAL")
        return wxFONTWEIGHT_NORMAL;
    else if (wtstr == "wxFONTWEIGHT_LIGHT")
        return wxFONTWEIGHT_LIGHT;
    else if (wtstr == "wxFONTWEIGHT_BOLD")
